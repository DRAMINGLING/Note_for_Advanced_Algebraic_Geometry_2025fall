...
\begin{proof}
    ...
    Note that by truncation $\tau^{\ge -1}$, $\totalcomplex (\mathcal{F}^{\bullet}, \ast)^{\ge -1} \rightarrow \mathbb{L}_{X}^{\ge -1}$ also a quasi-isomorphism,
    ...
    \par
    For the first equality, take a flat resolution of 
\end{proof}
\end{document}