...
\begin{proof}
    ...
    Hence $f$ induces an element in $\ker (\hom_{\mathscr{A}}(B^{0}, A) \overset{\circ \partial}{\rightarrow} \hom_{\mathscr{A}}(B^{-1}, A))$.
    By universal property of cokernel, the correspondence is bijective, done!
\end{proof}
