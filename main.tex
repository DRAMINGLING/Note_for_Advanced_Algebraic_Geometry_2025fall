...
\begin{proof}
    ...
    \begin{equation}
        \begin{tikzcd}
            ...
            0 \\
            A \arrow[r, hookrightarrow] \arrow[d, "id_{A}" swap] &
            B \arrow[r] \arrow[d] & 
            0 \\
            A \arrow[r] &
            0
...
\begin{proof}
    ...
    By Lemma \ref{Lemma 6.9}, $\mathcal{F}(A'^{\bullet}) = \mathcal{F}(A'''^{\bullet}) = \mathcal{F}(A''^{\bullet})$ in $\mathcal{D}(\mathscr{A})$,
\end{proof}
...
\begin{equation}
    ...
    \end{tikzcd}
\end{equation}
where $\widetilde{f}$ is the morphism in $\mathcal{D}(\mathscr{A}')$ given by Lemma \ref{Lemma 6.8}.
\par
...
and most of the proofs are same as their original version and we only provide proof of Lemma \ref{Lemma 6.12} here.
\begin{lemma}
    Let $A^{\bullet} \rightarrow B^{\bullet}$ be a chain map in $\mathcal{C}(\mathscr{A})$.
