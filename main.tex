...
\begin{definition}
    Let $\mathscr{A}, \mathscr{B}$ be abelian categories, $\mathcal{T}: \mathscr{A} \rightarrow \mathscr{B}$ an additive functor, $\mathscr{A}' \subseteq \mathscr{A}$ full additive category.
    We say that $\mathscr{A}'$ satisfies $\mathcal{T}$-condition if \\
    ...
    (3)$\mathcal{T}$ is an exact functor on $\mathscr{A}'$.
\end{definition}
\begin{lemma}
    Let $\mathscr{A}$ be an abelian category.
