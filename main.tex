...
\begin{proof}
    ...
    Hence just as proof of Lemma \ref{Lemma 6.14}, the natural map $\cone(q) \rightarrow I^{\bullet}[1]$ is null-homotopic.
...
\end{lemma}
\begin{proof}
    By Lemma \ref{Lemma 6.15}, we immediately get $H^{n}(\hom^{\bullet}(E', F)) = \hom_{\mathcal{D}(\mathscr{A})}(E', F[n])$ and $H^{n}(\hom^{\bullet}(E, F)) = \hom_{\mathcal{D}(\mathscr{A})}(E, F[n])$.
    Hence 
    \begin{equation}
...
\begin{remark}
    ...
    \begin{equation}
        \begin{split}
            ...
            & = \hom_{\mathcal{K}(\mathscr{A})}(A^{\bullet}, B'^{\bullet}) \\
            & = \hom_{\mathcal{D}(\mathscr{A})}(A^{\bullet}, B'^{\bullet}) \\
            & = \hom_{\mathcal{D}(\mathscr{A})}(A^{\bullet}, B^{\bullet})
        \end{split}
    \end{equation}
