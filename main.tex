...
\begin{proof}
    ...
    $C \rightarrow A$ factors through $C \twoheadrightarrow C/\mathcal{m}_{C}^{t}$ for large enough $t$.
...
\par
For complexes, by same strategy of construction of Cartan-Eilenburg resolution, we can also define hyper cohomology.
