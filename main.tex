...
\begin{lemma}
    ...
    \end{equation}
    In addition, dually, the following chain map is zero map $\mathcal{D}(\mathscr{A})$ if and only if it is zero map in $\mathcal{K}(\mathscr{A})$.
    \begin{equation}
        \begin{tikzcd}
            {[0} \arrow[r] \arrow[d] &
            {C]} \arrow[d, "f"] \\
...
\begin{proof}
    ...
    Assume chain map \ref{equation:chain_map_in_lemma_6.6} is zero map in $\mathcal{D}(\mathscr{A})$,
...
\begin{proposition}
    ...
    Then for all $i$, we have that $\hom_{\mathcal{D}(\mathscr{A})}(B^{\bullet}, A[i]) = \hom_{\mathcal{D}(\mathscr{A})}(B^{\ge i}, A[i])$ and $\hom_{\mathcal{D}(\mathscr{A})}(A[i], B^{\bullet}) = \hom_{\mathcal{D}(\mathscr{A})}(A[i], B^{\ge i})$.
...
\begin{proof}
    ...
    Hence $\tau^{\ge -1}Lf^{\ast}\mathbb{L}_{X}^{\ge -1} \rightarrow f^{\ast}\mathbb_{L}_{X}^{\ge -1}$ is a quasi-isomorphism.
    Thus by Proposition \ref{Proposition 6.2}, 
    \begin{equation}
        \ext_{T}^{1}(Lf^{\ast}\mathbb{L}_{X}^{\ge -1}, \mathcal{J}) = \hom_{\mathcal{D}(T)}(Lf^{\ast}\mathbb{L}_{X}^{\ge -1}, \mathcal{J}[1]) = \hom_{\mathcal{D}(T)}(\tau^{\ge -1}Lf^{\ast}\mathbb{L}_{X}^{\ge -1}, \mathcal{J}[1]) = \hom_{\mathcal{D}(T)}(f^{\ast}\mathbb{L}_{X}^{\ge -1}, \mathcal{J}[1])
    \end{equation}
    done!
\end{proof}
\end{document}