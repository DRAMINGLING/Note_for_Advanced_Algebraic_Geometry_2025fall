...
\begin{corollary}
    ...
    \begin{equation}
        \begin{tikzcd}
            ...
            & D^{\bullet} \arrow[dr, "f_{2}"] \arrow[dl, "g_{2}" swap] & \\
            B^{\bullet} &&
            A^{\bullet} \\
        \end{tikzcd}
    \end{equation}
    there exists chain map $h: C^{\bullet} \rightarrow D^{\bullet}$ such that commutative diagram up to homotopy
    \begin{equation}
        \begin{tikzcd}
...
\begin{lemma}
    ...
    Then for any $B^{\bullet}\in \mathcal{C}^{\le 0}(\mathscr{A})$, we have that $\hom_{\mathcal{D}(\mathscr{A})}(B^{\bullet}, A[0]) = \ker (\hom_{\mathscr{A}}(B^{0}, A) \overset{\circ \partial}{\rightarrow} \hom_{\mathscr{A}}(B^{-1}, A))$.
    Similarly, for any $B^{\bullet}\in \mathcal{C}^{\ge 0}(\mathscr{A})$, we have that $\hom_{\mathcal{D}(\mathscr{A})}(A[0], B^{\bullet}) = \ker (\hom_{\mathscr{A}}(A, B^{0}) \overset{\circ \partial}{\rightarrow} \hom_{\mathscr{A}}(A, B^{1}))$.
    \label{Lemma 6.7}
\end{lemma}
\begin{proof}
    ...
    By universal property of cokernel, we get a well defined map.
    \par
    ...
    \end{equation}
    By Lemma \ref{Lemma 6.5}, if we take $E^{\bullet} = \cone((f_{2}, g_{2}))$.
    Then there is a commutative diagram up to homotopy
    \begin{equation}
        \begin{tikzcd}
            & C^{\bullet} \arrow[dr, "f_{1}"] \arrow[dl, "g_{1}" swap] & \\
            B^{\bullet} \arrow[dr] &&
